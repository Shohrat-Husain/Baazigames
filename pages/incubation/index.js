          ...
          <div className="wpb_column vc_column_container vc_col-sm-12">
            <div className="vc_column-inner">
              <div className="wpb_wrapper">
                <div className="wpb_raw_code wpb_content_element wpb_raw_html vc_custom_1620451367054">
                  <div className="wpb_wrapper">
                    <div className="aboutusleftlinks">
                      <a
                        href="https://baazigames.com/incubation/"
                        className="active"
                      >
                        Incubation
                      </a>
                      ...
                      <div className="container">
                        <div className="innerwraper">
                          <div className="aboutus-content clearfix">
                            <div
                              className="about-thumb aligleft aos-init aos-animate"
                              data-aos="fade-in"
                              data-aos-offset="50"
                              data-aos-easing="ease-in-sine"
                            >
                              <picture>
                              <source srcSet="https://baazigames.com/wp-content/uploads/2021/03/Incubation-1.jpg" type="image/jpg" />
                              <img
                                src="https://baazigames.com/wp-content/uploads/2021/03/Incubation-1.jpg"
                                className="img-fluid w-100  h-auto"
                                alt="Online gaming company"
                              />
                              </picture>
                              <div className="overlapp"></div>
                            </div>
                            <div
                              className="comman-head aos-init"
                              data-aos="fade-in"
                              data-aos-offset="300"
                              data-aos-easing="ease-in-sine"
                            >
                              ...
                              <h2 className="heading-1 mb-3">
                                <span className="darkcolor">Helping You</span>
                                <span className="bluecolor">Grow</span>
                              </h2>
                              <p>
                                ...
                                startup an initial support to handholding,
                                nurturing and curating training as per our
