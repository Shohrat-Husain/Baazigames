...
const sections = [
  { id: "section1", title: "About Us", offset: 0 },
  { id: "section2", title: "Team", offset: 500 },
  { id: "section3", title: "Gaming Innovation", offset: 1000 },
  { id: "section4", title: "Technology Talks", offset: 1500 },
];
...
function index() {
  return (
    <>
      <Head>
        <title>About Us | Baazi Games</title>
        <meta
          name="description"
          content="Baazi Games is the fastest-growing skill based real money gaming company in India with over 7.5 million users."
        />
       <link
          rel="icon"
              ...
              <div className="innerwraper">
                <div className="aboutus-content clearfix">
                  <div className="about-thumb aligleft">
                    <picture>
                      <source
                        srcSet="https://baazigames.com/wp-content/uploads/2023/02/Aboutus-V2.jpg"
                        type="image/jpg"
                      />
                      <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0011_navkiran-min.jpg"
                              type="image/jpg"
                            />
                            <img
                      ...
                      <div className="col-md-7 col-orders-2 mb-4">
                        <div className="comman-head">
                          ...
                          <p>
                            ...
                            Envisioning it&apos;s potential, Poker in India
                            needed a home-grown platform and Navkiran had just
                            the skills to get started: Poker and Engineering. He
                            set out to eliminate the social stigma associated
                            with the sport and bring to light the potential of
                            new skill-based professional sports in India.
                            Leaving no stone unturned, Navkiran added further
                            games to the Baazi portfolio that include Rummy and
                            Fantasy Sports. Singh is a true flagbearer of the
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0007_Puneet-Singh-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0008_Anirudh-Chaudhry-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0010_Varun-Ganjoo-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0009_Avneet-Rana-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0002_Saurabh-Chopra-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0003_Sunit-Warraich-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0004_Sudeep-Godara-min.jpg"
                              type="image/jpg"
                            />
                            <img
                      ...
                      <div className="col-md-7 col-orders-2 mb-4">
                        <div className="comman-head">
                          ...
                          <p>
                            ...
                            drive the brand towards the vision of being
                            India&apos;s go-to platform for all things online
                            gaming.{" "}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0005_Gaurav-Kapoor-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2023/04/Pranay-Picture-opt.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0000_Parth-Sharma-min.jpg"
                              type="image/jpg"
                            />
                            <img
                      ...
                      <div className="col-md-7 col-orders-2 mb-4">
                        <div className="comman-head">
                          ...
                          <p>
                            ...
                            role of ‘Fixed Income Market Analyst&apos; makes him
                            just the player that the Baazi Games team needs.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2021/10/website-images_0001_Puneet-Dua-min.jpg"
                              type="image/jpg"
                            />
                            <img
                    ...
                    <div className="row mb-4">
                      <div className="col-md-5 col-orders-1 mb-4">
                        <div className="about-thumb">
                          <picture>
                            <source
                              srcSet="https://baazigames.com/wp-content/uploads/2023/04/Himank-Tripathi-opt.jpg"
                              type="image/jpg"
                            />
                            <img
              ...
              <div className="innerwraper">
                <div className="aboutus-content clearfix">
                  <div className="about-thumb aligright">
                    <picture>
                      <source
                        srcSet="https://baazigames.com/wp-content/uploads/2021/03/gaming-innovation.jpg"
                        type="image/jpg"
                      />
                      <img
                  ...
                  <div className="comman-head">
                    ...
                    <p>
                      ...
                      scintillating online gaming experience that&apos;s second
                      to none. Our nationwide platforms ensure you play alone
                      but game together, fostering a community of passionate
                      gamers.{" "}
                    </p>
                    <p>
              ...
              <div className="innerwraper">
                <div className="aboutus-content clearfix">
                  <div className="about-thumb aligleft">
                    <picture>
                      <source
                        srcSet="https://baazigames.com/wp-content/uploads/2021/03/tech_talk.jpg"
                        type="image/jpg"
                      />
                      <img
                  ...
                  <div className="comman-head">
                    ...
                    <p>
                      ...
                      every gamer&apos;s appetite. With a player centric
                      philosophy, responsive games came as second nature.
                      Keeping up with the ever evolving gaming architecture,
                      Baazi Games leaves no stone unturned, ensuring the
                      platforms adapt to the latest stacks.
                    </p>
                  </div>
                </div>
              </div>
